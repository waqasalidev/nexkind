/**
 * Client-side Fallback Events Dataset
 * Ensures Upcoming Events are ALWAYS available even if live API is slow, offline, or returns empty.
 * Prioritizes Pakistan, India, Bangladesh, and Global events.
 */
